...
const SCORE_TEXT_STYLE = {
    fontSize: '32px',
    // fill: '#fff', // Changed fill to color
    color: '#FFFFFF', // Explicitly use color
 ...
 */
export function createScoreDisplay(scene) { // Export this function
 ...
 */
export function updateScoreDisplay(scoreTextObject, newScore) { // Export this function
